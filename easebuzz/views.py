...
def section_page(request, section, page):
    """
    Dynamically render any allowed Easebuzz section/page pair
    """
    ...
    full_template = f"easebuzz/{section}/{page}.html"
    partial_template = f"easebuzz/partials/{section}_{page}.html"
